...
Давайте предприним первую попытку:
...
Хм... не плохо. Но здесь есть узкое место: если код потребует более 50 миллисекунд на сканирование, он начнет с начала...
...
Давайте сделаем шаг назад и подумаем: если бы у нас была полная история событий нажатия клавиш, смогли бы мы вычленить их нее последовательность событий сканирования кода? Будет ли код проще? Давайте выясним это...
