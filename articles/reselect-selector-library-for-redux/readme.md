...
Давайте определим мемоизированный селектор с именем `getVisibleTodos` на замену немемоизированной версии выше:
...
A: Для одних и тех же данных на входе, селектор должен всегда возвращать один и тот же результат. По этой причине их легко тестировать (unit test).
