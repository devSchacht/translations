...
Функция `dispatch` внутри `createStore` вызывает функцию редюсера и сохраняет **любое возвращаемое им значение**. Не смотря на это, идеи из вышеуказанного списка имеют широкое признание и любое хорошее Redux-приложение должно быть основанно на них.
