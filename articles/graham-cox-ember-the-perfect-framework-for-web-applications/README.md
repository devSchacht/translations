...
Ember.js - уверенный в себе фронтенд фреймворк, получивший много внимания в последнее время. Это статья познакомит вас с основными концепциями фреймворка на примере создания простого приложения и покажет что с его помощью можно сделать.
...
* Поддержка юнит, интеграционного и приемочного тестирования с помощью [Testem](https://github.com/testem/testem) и [QUnit](https://qunitjs.com/).
...
Это говорит нам о том, что сервер заметил наши изменения в шаблоне, перезапустил все каких-либо действий с нашей стороны.
...
На данный момент, благодаря относительно небольшим усилиям, мы создали приложение, которое позволяет нам бросать кости и просматривать историю бросков. Это включает в себя связывание данных из нашей формы, сохранение данных в хранилище и чтение их из него, шаблоны для показа всех страниц и навигацию с помощью URL роутинга. Такое приложение может быть создано с нуля за час.
