...
С одной стороны, это здорово, что означает большую и растущую доступность компонентов с открытым исходном кодом для всех,
...
1. Присваивать атрибуты нужным элементам
1. Придерживаются норм браузеров для навигации по клавиатуре
1. Отдавать предпочтение событиям, а не колбэкам
...
## Присваивать атрибуты нужным элементам
...
## Отдавать предпочтение событиям, а не колбэкам
