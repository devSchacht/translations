...
**Функциональное программирование как парадигма предполагает использование функций, не вызывающих сайд-эффекты.** Это означает, что функции должны просто выполнять операции над данными, переданными в функцию, и эффекты этих операций должны быть видны только тому, кто вызвал эту функцию. **Иммутабельные структуры данных идут рука об руку с функциями, не вызывающими сайд-эффекты.**
...
Ленивые вычисления могут также использоваться с **бесконечными структурами данных**.
