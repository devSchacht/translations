...
Если вы понимаете пять простых концепций, вы можете понять, как реактивность и кэширование (это вся магия, которая делает ваше приложение быстрым и плавным), работают в Apollo Client.
...
2. Apollo Client кэширует деревья результатов запроса. Для этого предполагается:
