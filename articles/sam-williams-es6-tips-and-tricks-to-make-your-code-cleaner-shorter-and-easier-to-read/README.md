...
Другая возможность оператора `...` это создание массива или объекта. В примере ниже создаётся новый массив `b`, но массив `c` просто ссылается на тот же самый массив.
