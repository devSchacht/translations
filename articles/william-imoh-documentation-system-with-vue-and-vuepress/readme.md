...
> Примечание переводчика: на данный момент доступен [неофициальный перевод документации VuePress](https://vuepress-lrouuhpdsl.now.sh/ru), который выполняется сообществом [Translation Gang](https://github.com/translation-gang/), которое занимается переводом Vue-продуктов, включая VuePress. До тех пор пока VuePress находится в стадии разработки, официальные переводы не принимаются, но сообщество уже перевело документацию VuePress и после выхода стабильной версии этот перевод будет использоваться на официальном сайте.
