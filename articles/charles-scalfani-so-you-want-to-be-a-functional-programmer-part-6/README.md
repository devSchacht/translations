...
Одним из первым таких языков был CoffeeScript. И сейчас на вооружение Angular 2 (*прим. пер.; "сейчас" актуально для Angular 5*) был принят TypeScript. Также транспилятором для JavaScript может считаться Babel. 
...
1. Программирование на чистом функциональном языке несёт в себе одновременно ограничение и освобождение. Ограничение заключаются в том, что вы можете сделать (зачастую, путём защиты вас от вас самих), но в то же время вы освобождаетесь от ошибок и плохих архитектурных решений, так как Elm-приложения следуют The Elm Architecture, функционально-реактивной модели.
...
Моей целью являлось помочь другим освоить все эти концепты легче и быстрее, чем мне самому это удалось, и помочь другим поднять их уровень в программировании, чтобы они стали более востребованными специалистами.
