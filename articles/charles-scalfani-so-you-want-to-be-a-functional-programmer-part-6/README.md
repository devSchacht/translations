...
Elm – это чистый функциональный язык, компилируемый в JavaScript, поэтому вы можете использовать его для создания веб-приложений, используя [архитектуру Elm](https://guide.elm-lang.org/architecture/), также называемую TEA (эта архитектура вдохновила разработчиков Redux).
...
Нет. Вы можете постепенно заменять части кода. Посмотрите в эту статью из блога: [How to use Elm at Work](http://elm-lang.org/blog/how-to-use-elm-at-work), – чтобы узнать побольше. 
