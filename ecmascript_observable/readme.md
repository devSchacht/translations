...
*Перевод [предложения](https://github.com/tc39/proposal-observable/blob/master/README.md) типа Observable в стандартную библиотеку ECMAScript. Актуален по состоянию на 31.03.2017.*
...
- *Ленивыми*: Observables не начинают испускать данные до тех пор, пока `observer` не подпишется.
...
function listen(element, eventName) {
    return new Observable(observer => {
        // Создаем обработчик событий, отпрай данные подписчику
